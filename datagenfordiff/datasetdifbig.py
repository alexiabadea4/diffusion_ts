...
import torch as T
import numpy as np
from .DGbig import generate_balanced_dataset_big

class SynthSignalsDatasetBig(T.utils.data.Dataset):
    ...
    def __init__(self, num_samples_per_class, noise_level=0.0, device=None):
        ...
        """
        x_tmp, y_tmp, signalclasses = generate_balanced_dataset_big(num_samples_per_class, noise_level)
